...
export function BusinessCard({ business, onDelete, isDeleting, index }: BusinessCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group"
    >
      <div className="relative bg-white/70 backdrop-blur-xl border border-white/50 shadow-sm hover:shadow-xl hover:shadow-[#8B6F47]/5 transition-all duration-300 rounded-2xl overflow-hidden">
