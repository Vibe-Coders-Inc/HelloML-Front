        ...
        <div className="w-full flex flex-col items-center">
          <div className="max-w-4xl mx-auto text-center">
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight mb-3 leading-[1.1]"
            >
          ...
          {/* Subtitle + CTA inline */}
          <div className="max-w-4xl mx-auto text-center">
            <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="text-base sm:text-lg text-[#8B7355] mb-4 max-w-xl mx-auto">
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.9 }} className="text-xs text-[#A67A5B]/50 mb-3">No credit card required</motion.p>
          </div>
          ...
          {/* Social proof */}
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.1 }} className="mt-6 pt-4 border-t border-[#E8DCC8]/30 w-full max-w-md text-center">
            ...
            <div className="flex items-center justify-center gap-8 sm:gap-14">
              ...
              <img src="/disney-logo.svg" alt="Disney" className="h-5 md:h-6 w-auto opacity-25" loading="lazy" style={{ filter: 'sepia(1) saturate(3) brightness(0.4) hue-rotate(350deg)' }} />
