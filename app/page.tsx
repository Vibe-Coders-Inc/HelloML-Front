...
/* ═══════════════════════════════════════════
   MAIN PAGE
   8 sections. Mixed serif/sans typography.
   Framer Motion: hero entrance only.
   Everything else: CSS scroll-driven animations.
   ═══════════════════════════════════════════ */
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F3] overflow-x-hidden">
      ...
      <section className="pt-28 md:pt-36 pb-12 flex flex-col items-center justify-center relative">
        ...
        >
          <h1 className="text-5xl sm:text-6xl md:text-8xl font-bold tracking-tight mb-5 leading-[1.05]">
      ...
      {/* ── 2. SOCIAL PROOF ── */}
      <div className="scroll-reveal text-center py-6 border-t border-[#E8DCC8]/30">
        ...
        <div className="flex items-center justify-center gap-10 sm:gap-14 md:gap-20">
          ...
          <img src="/disney-logo.svg" alt="Disney" className="h-7 md:h-9 w-auto opacity-40" loading="lazy" style={{ filter: 'sepia(1) saturate(3) brightness(0.4) hue-rotate(350deg)' }} />
      ...
      {/* ── 3. DASHBOARD ── */}
      <div className="dashboard-parallax w-full max-w-5xl mx-auto px-4 md:px-6 mt-4 mb-12" style={{ willChange: 'transform' }}>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="scroll-reveal">
            <h2 className="text-3xl md:text-5xl font-bold text-[#8B6F47] mb-2">
              <span style={{ fontFamily: 'Borel, cursive' }}>Three steps.</span> Five minutes. Done.
            </h2>
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="scroll-reveal flex flex-col items-center text-center" style={{ animationDelay: `${i * 80}ms` }}>
      ...
      <section className="py-16 md:py-20 px-4 bg-[#F5EFE6]">
        <div className="max-w-5xl mx-auto">
          <div className="scroll-reveal text-center mb-12">
            <h2 className="text-3xl md:text-5xl font-bold text-[#8B6F47] mb-2">
              Everything you need. <span style={{ fontFamily: 'Borel, cursive' }}>Nothing you don&apos;t.</span>
            </h2>
          </div>
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={i} className="scroll-reveal" style={{ animationDelay: `${i * 60}ms` }}>
      ...
      <section className="py-20 md:py-28 px-4 bg-[#111111] relative overflow-hidden">
        {/* Floating integration icons in background */}
      ...
      {/* ── 7. PRICING + CTA (inline, no card) ── */}
      <section className="py-16 md:py-20 px-4 text-center">
        <div className="scroll-reveal">
          <h2 className="text-3xl md:text-5xl font-bold text-[#8B6F47] mb-3">
            <span style={{ fontFamily: 'Borel, cursive' }}>$5/mo</span> per agent. 100 minutes included.
          </h2>
          <p className="text-lg text-[#8B7355] mb-8 max-w-md mx-auto">No contracts, no hidden fees. Cancel anytime.</p>
