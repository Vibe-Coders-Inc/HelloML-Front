    ...
    <div className="bg-[#FAF8F3]">
      ...
      <Slide className="bg-[#FAF8F3]">
        <div className="w-full flex flex-col items-center">
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.9 }} className="text-xs text-[#A67A5B]/50 mb-6">No credit card required</motion.p>
          </div>
          ...
          {/* Social proof */}
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.1 }} className="mt-6 pt-4 border-t border-[#E8DCC8]/30">
