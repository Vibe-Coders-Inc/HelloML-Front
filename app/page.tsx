...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F3] overflow-x-hidden">
      ...
      {/* ── 2. SOCIAL PROOF ── */}
      <FadeIn className="text-center py-6 border-t border-[#E8DCC8]/30">
        <p className="text-xs uppercase tracking-[0.2em] text-[#A67A5B]/60 font-medium mb-5">Built by engineers from</p>
      ...
      <section className="py-20 md:py-28 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <FadeIn className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-[#8B6F47] mb-4 leading-tight">
              Every missed call is a{' '}
              <span style={{ fontFamily: 'Borel, cursive' }}>lost</span>
              {' '}customer.
            </h2>
            <p className="text-base md:text-lg text-[#8B7355] max-w-lg mx-auto">
          ...
          >
            {[
              { icon: <DocumentIcon />, title: 'Tell us about your business', desc: 'Answer a few questions. Your hours, services, and how to book.' },
              { icon: <CalendarIcon />, title: 'Connect your calendar', desc: 'Google Calendar or Outlook. Bookings happen automatically.' },
              { icon: <PhoneIcon />, title: 'Start answering calls', desc: 'Get a local number. Your AI agent picks up 24/7.' },
            ].map((step, i) => (
              <motion.div
                key={i}
                variants={{
      ...
      <section className="py-24 md:py-32 px-4 bg-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          <FadeIn>
            <h2 className="text-3xl md:text-5xl font-bold text-[#FAF8F3] mb-3">
              Works with the tools you{' '}
              <span style={{ fontFamily: 'Borel, cursive' }} className="text-[#D4A96A]">already</span>
              {' '}use.
            </h2>
            <p className="text-base md:text-lg text-[#FAF8F3]/40 mb-12">Connects to your calendar, docs, and workflows.</p>
          </FadeIn>
              ...
              {integrations.map((logo, i) => (
                <div key={i} className="flex flex-col items-center gap-2">
                  ...
                  <img
                    src={logo.src}
                    alt={logo.name}
                    className="w-14 h-14 md:w-16 md:h-16 rounded-2xl shadow-2xl hover:scale-110 transition-transform duration-300"
                    loading="lazy"
                  />
          ...
          <FadeIn delay={0.25}>
            <div className="grid grid-cols-3 gap-4 md:gap-8">
              <div>
                <div className="text-3xl md:text-5xl font-bold text-[#D4A96A]">&lt;<CountUp target={500} />
                  <span className="text-lg md:text-2xl">ms</span>
                </div>
                <div className="text-xs text-[#FAF8F3]/30 mt-1">Response time</div>
              </div>
              <div>
                <div className="text-3xl md:text-5xl font-bold text-[#D4A96A]">
                  <CountUp target={99} />.9<span className="text-lg md:text-2xl">%</span>
                </div>
