  ...
  return (
    <div className="relative h-48 sm:h-40 max-w-lg mx-auto">
      {useCases.map((uc, i) => (
        ...
        >
          <span className="text-4xl mb-3">{uc.persona}</span>
...
function HowItWorksSteps() {
  ...
  const steps = [
    ...
    ), title: 'Upload your docs', desc: 'FAQs, menus, policies — your agent learns it all.', fromX: -40, fromY: 0 },
    { icon: (
    ...
    ), title: 'Connect your calendar', desc: 'Google Calendar, Outlook — bookings happen automatically.', fromX: 40, fromY: 0 },
    { icon: (
    ...
    ), title: 'Calls answered', desc: '24/7. On your dedicated number. Instantly.', fromX: 0, fromY: 40 },
  ];
  ...
  return (
    <div ref={ref} className="grid sm:grid-cols-3 gap-8 md:gap-12">
      {steps.map((step, i) => (
        <motion.div
          key={i}
          initial={{ opacity: 0, x: step.fromX, y: step.fromY }}
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F3] overflow-x-hidden">
      ...
      {/* ───────── 1. HERO ───────── */}
      <section className="min-h-[80vh] md:min-h-screen flex flex-col items-center justify-center pt-24 md:pt-40 relative">
        ...
        <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-4xl mx-auto text-center px-6 relative z-10">
          <motion.h1 variants={staggerItem} className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold text-[#8B6F47] tracking-tight mb-4">
            AI that <span style={{ fontFamily: 'Borel, cursive' }}>answers</span> your phone.
          </motion.h1>
          <motion.p variants={staggerItem} className="text-xl sm:text-2xl md:text-3xl text-[#8B7355] font-medium mb-3">
            Sounds like a human. Works like a machine.
          </motion.p>
          <motion.p variants={staggerItem} className="text-sm sm:text-base md:text-lg text-[#8B7355]/70 mb-2 max-w-2xl mx-auto leading-relaxed px-2">
            Powered by the latest in voice AI — your calls answered 24/7, appointments booked, questions handled.
          </motion.p>
      ...
      <AnimatedSection className="py-16 md:py-32 px-4 md:px-6 bg-gradient-to-b from-[#FAF8F3] to-[#F5EFE6]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#8B6F47] mb-2">How it works</h2>
          <p className="text-base md:text-lg text-[#8B7355] mb-16">Set up in 60 seconds. Seriously.</p>
          <HowItWorksSteps />
        </div>
      </AnimatedSection>
      ...
      <AnimatedSection className="py-16 md:py-32 px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base md:text-lg text-[#8B7355] mb-12">Watch a robotic IVR transform into natural conversation.</p>
          <WaveformComparison />
        </div>
      </AnimatedSection>
      ...
      <AnimatedSection className="py-20 md:py-36 px-4 md:px-6 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-[#F5EFE6]/50 via-[#EDE3D3]/30 to-[#FAF8F3]/50 pointer-events-none" />
          ...
          <div className="relative inline-block mb-10">
            <div className="w-56 h-96 sm:w-64 sm:h-[28rem] rounded-[2.5rem] border-4 border-[#8B6F47]/20 bg-white/40 backdrop-blur-sm flex flex-col items-center justify-center relative overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                ...
                <div className="absolute w-64 h-64 rounded-full border border-[#8B6F47]/[0.03] animate-pulse-ring" style={{ animationDelay: '1s' }} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-50px' }} variants={staggerContainer} className="grid sm:grid-cols-2 gap-6 md:gap-8">
            {[
              ...
              <motion.div key={i} variants={staggerItem} className="group p-6 md:p-8 rounded-2xl bg-white/50 border border-[#E8DCC8]/50 hover:border-[#8B6F47]/20 hover:-translate-y-2 hover:shadow-2xl hover:shadow-[#8B6F47]/10 transition-all duration-300 will-change-transform relative overflow-hidden">
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none bg-gradient-radial from-[#8B6F47]/[0.03] via-transparent to-transparent" />
                <div className="text-3xl mb-4 relative">{f.icon}</div>
                <h3 className="text-lg md:text-xl font-semibold text-[#8B6F47] mb-2 relative">{f.title}</h3>
                <p className="text-[#8B7355] text-sm md:text-base relative">{f.desc}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <AnimatedSection className="py-16 md:py-32 px-4 md:px-6 bg-gradient-to-b from-[#F5EFE6] to-[#FAF8F3]">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#8B6F47] mb-4">Built for businesses that can&apos;t miss a call.</h2>
          <p className="text-base md:text-lg text-[#8B7355] mb-12">Your agent works while you work.</p>
          <UseCaseCarousel />
        </div>
      </AnimatedSection>

      {/* ───────── 9. INTEGRATION MARQUEE ───────── */}
      ...
      <AnimatedSection className="py-16 md:py-32 px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="max-w-sm mx-auto bg-white/30 backdrop-blur-xl border border-[#E8DCC8]/60 rounded-3xl p-8 shadow-lg shadow-[#8B6F47]/5 hover:shadow-2xl hover:shadow-[#8B6F47]/15 hover:border-[#8B6F47]/20 transition-all duration-500 mb-8 relative overflow-hidden group">
      ...
      <AnimatedSection className="py-16 md:py-32 px-4 md:px-6 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          <motion.h2 initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#8B6F47] mb-4">
            Your calls, <span style={{ fontFamily: 'Borel, cursive' }}>answered</span>.
          </motion.h2>
          <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="text-[#8B7355] mb-8">No credit card required</motion.p>
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: 0.3, duration: 0.5 }}>
            <Link href="/auth?mode=signup">
